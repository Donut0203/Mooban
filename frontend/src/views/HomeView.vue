<template>
  <div class="home">
    <h1>กลุ่มออมทรัพย์เพื่อการผลิต หมู่บ้านเขาแหลม</h1>
        ...
        <div class="tab-content">
          ...
          <div class="news-container">
            ...
            <div class="news-item">
              ...
              <h3 class="news-title">ข้อมูลเกี่ยวกับกลุ่มออมทรัพย์เพื่อการผลิต</h3>
              <div class="news-content">
                <p>กลุ่มออมทรัพย์เพื่อการผลิต เริ่มต้นในปี 2526 (ค.ศ. 1983) โดยกรมการพัฒนาชุมชน กระทรวงมหาดไทย เป็นโครงการที่จัดตั้งขึ้นเพื่อ 
                  ส่งเสริมการออม และ สร้างแหล่งเงินทุนหมุนเวียนในชุมชน</p>
                <p>วัตถุประสงค์ของโครงการ:</p>
                <ul>
                  <li>ส่งเสริมให้ชาวบ้านมีนิสัยการออม เพื่อสร้างความมั่นคงทางการเงิน</li>
                  <li>ให้สมาชิกสามารถกู้ยืมเงินจากกลุ่ม เพื่อใช้จ่ายในกิจกรรมที่เป็นประโยชน์ เช่น การประกอบอาชีพ</li>
                  <li>ลดการพึ่งพาหนี้นอกระบบ ที่มีดอกเบี้ยสูง</li>
                  <li>ส่งเสริมการบริหารจัดการทางการเงินในชุมชน อย่างมีประสิทธิภาพ</li>
                </ul>
              </div>
              <div class="news-footer">
                <span class="news-author">โดย:หมู่บ้านเขาแหลม</span>
              </div>
            </div>
