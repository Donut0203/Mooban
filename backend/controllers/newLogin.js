...
exports.login = async (req, res) => {
  try {
    ...
    // Special case for user ID 20 - ensure they have headman status
    if (user.user_id === 20 && (!userStatus || userStatus === 'undefined')) {
      userStatus = 'headman';
      ...
      console.log('Updated user 20 status to headman');
    }
