-- สร้างตารางข้อตกลงเงินกู้ (Loan Agreement)
CREATE TABLE IF NOT EXISTS loanagreement (
  ...
  total_amount DECIMAL(15,2) NOT NULL,  -- จำนวนเงินรวม (เงินต้น + ดอกเบี้ย)
  ...
  FOREIGN KEY (member_id) REFERENCES member(member_id)  -- เชื่อมโยงกับตารางสมาชิก (member)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- สร้างตารางผู้ค้ำประกัน (Guarantor)
...
-- สร้างตารางการชำระเงินกู้ (Loan Repayments)
...
-- สร้างตารางธุรกรรม (Transactions) สำหรับการฝาก ถอน และการชำระหนี้
